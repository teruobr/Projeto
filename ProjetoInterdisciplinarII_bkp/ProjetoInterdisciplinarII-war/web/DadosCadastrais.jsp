...
<html>
    ...
    <body>
        ...
        %>
        <form action="CadastraCompleto" method="post" >
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="lstFaculdade" required="true">
                                ...
                                %>
                                <option value="<%=Universidade.get(i).getNome()%>"><%=Universidade.get(i).getNome()%></option>
                                <%       }
                                    }%>
                            </select>
                        </td>
                        ...
                        <td>
                            <select name="lstArea" required="true">
                                ...
                                <option value="Gerência">Ger&ecirc;ncia</option>
                                ...
                                %>
                                <option value="<%=areasAtuacao.get(i).getNome()%>"><%=areasAtuacao.get(i).getNome()%></option>
                                <%       }
                                    }%>
