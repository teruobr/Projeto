 ...
 */
@WebServlet(name = "AreaAtuacaoPublico", urlPatterns = {"/AreaAtuacaoPublico"})
public class AreaAtuacaoPublico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect(response.encodeRedirectURL("AreaAtuacaoPublico.jsp"));
        } finally {
            out.close();
        }
    }
