 ...
 * @author Thiago
 */
@WebServlet(name = "AtualizaMinhasCandidaturas", urlPatterns = {"/AtualizaMinhasCandidaturas"})
public class AtualizaMinhasCandidaturas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (usuario != null) {
                ...
                response.sendRedirect(response.encodeRedirectURL("MinhasCandidaturas.jsp"));
            }
